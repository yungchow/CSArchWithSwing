...
public class PolymorphicJList extends JList {
    ...
    protected void buildIcons() {
        ...
        fileIcon = new ImageIcon (ImagePath.LISTS+ SEP + "generic.gif");
        textFileIcon = new ImageIcon (ImagePath.LISTS + SEP + "text.gif");
        directoryIcon = new ImageIcon (ImagePath.LISTS + SEP + "folder.gif");
        imageFileIcon = new ImageIcon (ImagePath.LISTS + SEP + "image.gif");
        pngFileIcon = new ImageIcon (ImagePath.LISTS + SEP + "png.gif");
        gifFileIcon = new ImageIcon (ImagePath.LISTS + SEP + "gif.gif");
        jpegFileIcon = new ImageIcon (ImagePath.LISTS + SEP + "jpeg.gif");
    }
