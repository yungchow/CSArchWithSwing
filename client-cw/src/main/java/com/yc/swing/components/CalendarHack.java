...
public class CalendarHack extends JPanel {
    ...
    public CalendarHack() {
        background = new ImageIcon(ImagePath.COMPONENTS+"03/calendar.png").getImage();
        highlight = new ImageIcon(ImagePath.COMPONENTS+"03/highlight.png").getImage();
        day_img = new ImageIcon(ImagePath.COMPONENTS+"03/day.png").getImage();
